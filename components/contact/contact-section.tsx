      ...
      <div className="mx-auto max-w-6xl px-6">
        <Reveal>
          <SectionHeading
            eyebrow="Contatti"
            title="Scrivimi"
            description="Per richieste editoriali, informazioni sui libri, presentazioni e collaborazioni, puoi contattare direttamente l'autore."
            align="center"
          />
        </Reveal>
        ...
        <Reveal delay={120}>
          <div className="mx-auto mt-12 max-w-2xl rounded-2xl border border-border bg-background p-8 shadow-sm md:p-10">
            <div className="flex items-center justify-center gap-3 text-accent">
              ...
              <span className="text-sm font-medium uppercase tracking-[0.2em]">Email</span>
            </div>
